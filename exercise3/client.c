...
void get_valueTest()
{
    ...
    if (result == 0)
    {
        ...
        char comp_svalue1[256] = "TEST SET VALUE";
        int comp_ivalue2 = 2;
        float comp_fvalue3 = 3.5f;
...
void get_valueTest2()
{
    ...
    if (result == 0)
    {
        ...
        // Check that the function retrieves the correct values from the database
        char comp_svalue1[256] = "TEST SET VALUE 2";
        int comp_ivalue2 = 3;
        float comp_fvalue3 = 4.5f;
...
int main()
{
    ...
    init();
    init_Test(); // We make init_Test here because it makes more sense than having it on threads.
